/* Farmer surface — WhatsApp Business API storyboard.
   Per CLAUDE.MD scope: WhatsApp bot is NOT a real product surface.
   These four screens exist as a video-demo gallery only. View-only. */

import type { CSSProperties, ReactNode } from 'react';

// ─────────────────────────── iOS device bezel (minimal port of ios-frame.jsx) ───────────────────────────
...
function WAHeader({ subtitle = 'akun resmi · terverifikasi ✓' }: { subtitle?: string }) {
  return (
    <div
      style={{
        background: '#1f5d4c',
...
const waChat: CSSProperties = {
  background: '#e7ddd2',
  backgroundImage:
    'radial-gradient(circle at 12px 12px, rgba(0,0,0,.04) 1px, transparent 1.5px)',
...
function In({ children, small = false }: { children: ReactNode; small?: boolean }) {
  return (
    <div
      style={{
        alignSelf: 'flex-start',
        maxWidth: small ? '78%' : '88%',
        background: '#fff',
        padding: '8px 11px',
...
function Tm({
  ...
  return (
    <div style={{ fontSize: 10, color: '#7a8a83', textAlign: align, marginTop: 3 }}>
      {children}
    </div>
  );
}
...
// ─────────────────────────── Photographic flooded paddy SVG ───────────────────────────
...
function FloodedPaddyPhoto() {
  return (
    ...
    >
      ...
      <path
        d="M 0 165 L 22 152 L 44 158 L 70 145 L 92 155 L 118 142 L 142 156 L 168 148 L 196 152 L 224 144 L 252 156 L 280 148 L 310 154 L 340 146 L 372 156 L 400 150 L 400 175 L 0 175 Z"
        fill="url(#fpTree)"
        filter="url(#fpBlur)"
      />
      ...
      <g opacity="0.9">
        <path
          d="M -20 178 Q 80 172 200 178 T 420 176 L 420 188 Q 220 184 100 188 T -20 190 Z"
          fill="#5a4f3a"
        />
        <path
          d="M -20 196 Q 90 192 210 200 T 420 198 L 420 210 Q 200 206 100 212 T -20 212 Z"
          fill="#6a5e44"
          opacity="0.85"
        />
      </g>
      ...
      <path
        d="M -20 270 Q 100 258 220 268 T 420 264 L 420 300 L -20 300 Z"
        fill="#4a3f2a"
      />
    ...
    >
      ...
      <div style={waChat}>
        ...
        <In>
          ...
          >
            ...
            <div style={{ padding: '12px' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, fontSize: 12 }}>
                <div>
                  <div style={{ color: '#7a8a83', fontSize: 11 }}>Lahan</div>
                  <div style={{ fontWeight: 600 }}>1,4 ha · Ciherang</div>
                </div>
                <div>
                  <div style={{ color: '#7a8a83', fontSize: 11 }}>Pertanggungan</div>
                  <div style={{ fontWeight: 600 }}>Rp 9.240.000</div>
                </div>
                <div>
                  <div style={{ color: '#7a8a83', fontSize: 11 }}>Musim</div>
                  <div style={{ fontWeight: 600 }}>Apr–Jul 2026</div>
                </div>
                <div>
                  <div style={{ color: '#7a8a83', fontSize: 11 }}>Premi</div>
                  <div style={{ fontWeight: 600 }}>Sudah dibayar</div>
                </div>
              </div>
              <div
                style={{
          ...
          >
            {['📋 Lihat klaim saya', '📞 Hubungi pengurus koperasi', '🌾 Tanda mangsa minggu ini'].map(
              (b, i) => (
                <div
                  key={i}
                  style={{
        ...
        <In>
          ...
          >
            {['📞 Telepon agen koperasi', '💬 Chat dengan staf manusia', '📖 FAQ · pertanyaan umum'].map(
              (b, i) => (
                <div
                  key={i}
                  style={{
...
// ─────────────────────────── Screen 2: Daily mangsa observation ───────────────────────────
    ...
    >
      ...
      <div style={waChat}>
        ...
        <In>
          ...
          <div style={{ marginTop: 4, fontSize: 13, color: '#3a4a43' }}>Pilih salah satu di bawah:</div>
        ...
        <In>
          ...
          <div style={{ marginTop: 6 }}>Boleh kirim foto atau pesan suara biar lebih jelas?</div>
          <div
            style={{
              marginTop: 8,
              paddingTop: 6,
            ...
            <svg width="120" height="20" viewBox="0 0 120 20">
              {Array.from({ length: 24 }).map((_, i) => (
                <rect
                  key={i}
                  x={i * 5}
                  y={10 - 6 * Math.abs(Math.sin(i * 0.7))}
                  width="2.5"
                  height={12 * Math.abs(Math.sin(i * 0.7)) + 2}
                  fill="#1f5d4c"
                />
              ))}
            </svg>
    ...
    >
      ...
      <div style={waChat}>
        ...
        <In>
          ...
          <div style={{ marginTop: 6 }}>
            Bapak terpilih acak sebagai saksi untuk klaim banjir di <strong>Desa Sidorejo</strong>{' '}
            (≈ 9 km dari Bapak).
          </div>
          <div
            style={{
        ...
        <In>
          <div style={{ fontWeight: 600 }}>
            Menurut pengamatan Bapak, apakah betul sawah Sidorejo tergenang lebih dari 48 jam?
          </div>
          ...
          >
            {['✅ Ya, betul', '❌ Tidak, sawahnya kering', '🤷 Tidak tahu / belum lihat'].map(
              (b, i) => (
                <div
                  key={i}
                  style={{
        ...
        <In>
          ...
          <div style={{ marginTop: 6, fontSize: 13 }}>
            Suara Bapak ditandatangani secara kriptografis dan disimpan di rantai publik. Pulsa Rp
            1.500 sudah dikirim sebagai pengganti waktu Bapak.
          </div>
          <div
            style={{
              marginTop: 8,
    ...
    >
      ...
      <div style={waChat}>
        ...
        <In>
          <div style={{ fontWeight: 600 }}>Selamat pagi, Pak Suparjo. 🌾</div>
          <div style={{ marginTop: 6 }}>
            Banjir di sawah Desa Sidorejo telah <strong>terkonfirmasi</strong> oleh tiga sumber:
            citra satelit, sebelas tetangga, dan tanda-tanda mangsa.
          </div>
          <div style={{ marginTop: 6 }}>
            Pencairan otomatis sudah dikirim ke rekening Bapak.
          </div>
          <Tm>06:18 ✓✓</Tm>
        </In>
        ...
        <In>
          ...
          >
            ...
            <div style={{ fontSize: 12, color: '#3a5a1d', marginTop: 4 }}>
              ke BCA ****8842 · 22 Apr · 06:18
            </div>
            <div
              style={{
                marginTop: 10,
                paddingTop: 10,
                borderTop: '1px dashed #b9d49a',
                fontSize: 12,
                color: '#3a5a1d',
                display: 'flex',
...
const screens: Array<{ label: string; sub: string; node: ReactNode }> = [
  {
    label: 'A · Onboarding & status',
    sub: 'Ketik STATUS untuk ringkasan polis',
    node: <WAOnboardingScreen />,
  },
  {
    label: 'B · Pengamatan harian',
    sub: 'Bio-indikator mangsa via list-reply',
    node: <WAObservationScreen />,
  },
  {
    label: 'C · Atestasi antar-desa',
    sub: 'Saksi acak via VRF · 24 jam window',
    node: <WAAttestationScreen />,
  },
  {
    label: 'D · Pencairan klaim',
    sub: 'Template message · langsung ke rekening',
    node: <WAPayoutScreen />,
  },
];
...
export function Storyboard() {
  return (
    ...
    >
      <div style={{ maxWidth: 1280, margin: '0 auto', marginBottom: 32 }}>
        <div
          style={{
            fontFamily: 'var(--f-mono)',
            fontSize: 10,
        ...
        >
          Storyboard · Petani · WhatsApp Business API
        </div>
        <div
          style={{
            fontFamily: 'var(--f-display)',
        ...
        >
          Tanpa aplikasi terpisah — semua interaksi via WhatsApp resmi
        </div>
        <div
          style={{
            marginTop: 8,
        ...
        >
          Empat alur kunci yang dilihat petani: onboarding, pengamatan harian Pranata Mangsa,
          atestasi antar-desa, dan notifikasi pencairan klaim. Storyboard saja — bukan implementasi
          produk. Untuk video demo.
        </div>
      </div>
      ...
      >
        {screens.map((s, i) => (
          ...
          >
            <IOSDevice>{s.node}</IOSDevice>
            <div style={{ textAlign: 'center', maxWidth: 390, marginTop: 4 }}>
              <div
                style={{
                  fontFamily: 'var(--f-mono)',
                  fontSize: 10,
